...
occ_mbs <- read.csv('data/raw/occurrence/polygon_data_mbs.csv', stringsAsFactors = FALSE)
...
occ_raw <- read.csv('data/raw/occurrence/parasite_data_mbs_bigpolys_excluded.csv', stringsAsFactors = FALSE)
...
fascicularis <- read.csv('data/clean/occurrence/fascicularis_presence.csv', stringsAsFactors=FALSE)
nemestrina <- read.csv('data/clean/occurrence/nemestrina_presence.csv', stringsAsFactors = FALSE)
monkey_bias <- read.csv('data/clean/occurrence/mammals-bias.csv', stringsAsFactors = FALSE)
...
dat_covs <- raster::extract(covs_current, dat[, c('Longitude', 'Latitude')])
...
for (year in 2001:2012) {
  ...
  # extract data
  covs_year_extract <- raster::extract(covs_year, dat[idx, c('Longitude', 'Latitude')])
